...
constexpr uint64_t OFF_IN_JUMP = 0x0769b778;    //[Buttons]->in_jump
constexpr uint64_t OFF_IN_DUCK = 0x0769b868;    //[Buttons]->in_duck
...
constexpr uint64_t OFFSET_WALL_RUN_START_TIME = 0x3614; //[RecvTable.DT_LocalPlayerExclusive]->m_wallRunStartTime
constexpr uint64_t OFFSET_WALL_RUN_CLEAR_TIME = 0x3618; //RecvTable.DT_LocalPlayerExclusive]->m_wallRunClearTime

// Player
constexpr uint64_t OFF_VIEW_MATRIX = 0x11a350;   //[RecvTable.DT_Player]->ViewMatrix
constexpr uint64_t OFF_VIEW_RENDER = 0x769b558;  //[RecvTable.DT_Player]->ViewRender
...
constexpr uint64_t OFF_PROJECTILESCALE = 0x1EC4 + 0x8; //CWeaponX!m_flProjectileScale //[WeaponSettings]->projectile_gravity_scale + [WeaponSettingsMeta].base
constexpr uint64_t OFF_PROJECTILESPEED = 0x1EC4; //CWeaponX!m_flProjectileSpeed //[WeaponSettings]->projectile_launch_speed + [WeaponSettingsMeta].base
...
constexpr uint64_t OFF_GLOW_HIGHLIGHTS = 0xb13c6a0;
