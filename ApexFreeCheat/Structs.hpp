...
struct GlowMode {
    byte bodyStyle, borderStyle, borderWidth, transparency;

    GlowMode() {}

    GlowMode(int bodyStyle_val, int borderStyle_val, int borderWidth_val, int transparency_val) :
        bodyStyle(static_cast<byte>(bodyStyle_val)),
        borderStyle(static_cast<byte>(borderStyle_val)),
        borderWidth(static_cast<byte>(borderWidth_val)),
        transparency(static_cast<byte>(transparency_val)) {}


    GlowMode(byte bodyStyle_val, byte borderStyle_val, byte borderWidth_val, byte transparency_val) :
